...
echo ""
echo -e "${BLUE}Opção 1 - Configuração automática (recomendado):${NC}"
echo "  sudo \"\$(which docker-local)\" setup:dns"
echo ""
echo "  Isso configura o NetworkManager para resolver *.test e *.localhost"
echo "  automaticamente para 127.0.0.1"
echo ""
...
echo "  • https://whisper.localhost   - Whisper ASR API"
...
echo "  │ Whisper     │ latest   │ localhost:9501   │ -                      │"
echo "  └─────────────┴──────────┴──────────────────┴────────────────────────┘"
echo ""
echo "Xdebug:"
